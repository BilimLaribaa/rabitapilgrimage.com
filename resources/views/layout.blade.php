...
<!-- Mirrored from kodeforest.net/html/islamic/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Sep 2024 11:28:37 GMT -->
    ...
    <header class="header">
        ...
        <div class="kode_navigation_wrap">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="top_logo">
                    <h1>
                        <a href="#"><img src="{{ url('public/islamic/images/top-logo2.png') }}" width="70%" alt="img"></a>
                    </h1>
                </div>
                <div class="navigation" style="width:30%; margin-left:150px;">
                    <ul class="d-flex list-unstyled mb-0">
                        <li class="me-3"><a href="{{ url('/') }}">Home</a></li>
                        <li class="me-3"><a href="{{ url('/about') }}">About Us</a></li>
                        <li class="me-3"><a href="{{ url('/services') }}">Services</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="widget_logo" style="color: white;">
                                <a href="#"><img src="{{ url('public/islamic/images/footer-logo.png') }}"
                                        alt=""></a>
                        ...
                        <div class="col-md-4">
                            <div class="widget_event">
                                ...
                                <ul class="d-flex list-unstyled mb-0">
                                    <li class="me-3"><a href="{{ url('/') }}" style="color: white;">Home</a>
                                    </li>
                                    <li class="me-3"><a href="{{ url('about') }}" style="color: white;">About Us</a>
                                    </li>
                                    <li class="me-3"><a href="{{ url('services') }}"
...
<!-- Mirrored from kodeforest.net/html/islamic/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Sep 2024 11:29:33 GMT -->
